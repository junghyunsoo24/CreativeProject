...
public enum Sectors {
    ...
    사업시설_관리__사업_지원_및_임대_서비스업("N","사업시설 관리, 사업 지원 및 임대 서비스업"),
    공공_행정__국방_및_사회보장_행정("O", "공공 행정, 국방 및 사회보장 행정"),
    교육_서비스업("P","교육 서비스업"),
    보건업_및_사회복지_서비스업("Q", "보건업 및 사회복지 서비스업"),
    예술__스포츠_및_여가관련_서비스업("R", "예술, 스포츠 및 여가관련 서비스업"),
    협회_및_단체__수리_및_기타_개인_서비스업("S","협회 및 단체, 수리 및 기타 개인 서비스업");
